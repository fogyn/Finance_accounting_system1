...
public class Trati extends AbsModel implements Serializable {
    ...
    public Trati(String name, String numberCard, String type, float summa, boolean payOk, String text, float allprice, float ostatokprice){
        this.name = name;
    ...
    public Trati(String name, String numberCard, String type, float summa, boolean payOk) {
        this.name = name;
        this.numberCard = numberCard;
        this.type = type;
        this.summa = summa;
    ...
    public Trati(String name, String numberCard, String type, float summa, boolean payOk, String text) {
        this.name = name;
        this.numberCard = numberCard;
        this.type = type;
        this.summa = summa;
